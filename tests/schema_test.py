"""This is an example of json schema for the data dictionary using schemas defined
in local yaml files.
...
class SchemaTest(unittest.TestCase):
    def setUp(self):
        self.dictionary = pydatadict.DataDictionary()
...
if __name__ == '__main__':
    ...
    # Load schemata
    dictionary = pydatadict.DataDictionary()
